                ...
                <div className='w-full md:w-1/2 bg-gray-100 flex flex-col p-8 md:p-30 justify-between items-center'>
                    ...
                    <div className='w-full max-w-[500px]'>
                        <div className='w-full flex flex-col mb-4'>
                            <h3 className='text-2xl text-[#060606] font-semibold mb-2'>Sign Up</h3>
                        ...
                        <form className='w-full flex flex-col' onSubmit={(e) => e.preventDefault()}>
                            ...
                            <input type="password" placeholder='Confirm Password' className='w-full text-[#060606] py-2 my-2 bg-transparent border-b border-black outline-none focus:outline-none' />
                            <button type='submit' className='w-full my-4 bg-[#060606] rounded-md font-semibold p-3 text-white text-center'>Register</button>
                        </form>
                        ...
                        <div className='flex items-center justify-center w-full'>
                            <p className='text-sm font-normal text-[#060606]'>Already have an account? <Link to='/login' className='font-semibold underline underline-offset-2 cursor-pointer'>Sign In</Link></p>
                        </div>
                    </div>
                </div>
            </div>
